# Forward Deployed Strategist — Part 1 — LinkedIn post copy

Article: https://ensolabs.ai/insights/forward-deployed-strategist-agency-lineage
Carousel: `carousel.pdf` (upload as a LinkedIn document post)
Boost video: `boost-video-4x5.mp4`
Square pull-quote: `pull-quote-square.png`
...
New York just passed San Francisco.

Not in tech headcount overall — in the one role every AI company is fighting to fill. About 35% of U.S. forward-deployed postings are now in New York, against San Francisco's 11%, concentrated in fintech and other regulated industries.
...
Palantir never sent one person. It sent two.

A Forward Deployed Engineer who writes the code, and a Deployment Strategist who reads the business, defines the outcome, and gets a skeptical organization to actually adopt the thing. Go read Palantir's own description of that second seat — it isn't an engineering posting. It's a strategist's.
...
## Variant C — practitioner hook

Fifteen years inside McCann, RAPP, DDB, BBDO, Y&R, and Rokkan. Two years shipping production AI systems at Enso Labs. Same job.

The disciplines that ran Madison Avenue for decades — segmentation, the creative brief, campaign measurement — turn out to be exactly what a forward-deployed AI strategist does, wearing a different name. The brief becomes the system prompt. The rollout becomes the agent in production. The measurement plan becomes the eval harness.
