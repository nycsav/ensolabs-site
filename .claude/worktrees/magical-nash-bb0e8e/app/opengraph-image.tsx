...
export const alt = 'Enso Labs — Strategy to Ship';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Strategy{' '}
          <span style={{ color: 'oklch(0.82 0.13 195)', fontStyle: 'italic', fontWeight: 400 }}>to</span>
          {' '}Ship.
        </div>
        {/* Lede */}
        <div
        ...
        >
          Principal-led AI transformation. We consult, build, and ship — fast.
        </div>
        {/* Bottom divider */}
        <div
          style={{
