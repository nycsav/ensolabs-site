...
type Ev = { d: string; t: string; n: string; v: string; star?: boolean };
...
const EVENTS: Ev[] = [
  ...
  { d: '2026-06-03', t: '6:00 PM', n: 'AI Tinkerers Demo Day', v: '598 Broadway', star: true },
  { d: '2026-06-04', t: '11:30 AM', n: 'AI Agents: How To Keep Pace', v: '18 E 50th St' },
  { d: '2026-06-04', t: '2:00 PM', n: 'OpenAI Builder Lounge', v: 'OpenAI HQ, 295 Lafayette St' },
  ...
  return (
    <main className="shell" style={{ paddingTop: 120, paddingBottom: 96, maxWidth: 720 }}>
      ...
      <p style={{ color: 'var(--fg-2)', fontSize: 17, maxWidth: 560, margin: '0 0 14px' }}>
        I&rsquo;m Sav Banerjee, founder of Enso Labs. Here&rsquo;s my week — if any of these overlap with yours, come say hi.
      </p>
      ...
      <div style={{ background: 'var(--bg-2)', border: '1px solid var(--teal-dim)', borderRadius: 12, padding: '13px 16px', marginBottom: 8, fontSize: 14, color: 'var(--fg-2)' }}>
        <span style={{ color: 'var(--teal)' }}>★ Best bets to catch me:</span> AI Tinkerers Demo Day (Wed), 2x AI w/ Anthropic (Thu), and the Arize Builders Meetup (Jun 10).
      </div>
            ...
            <div key={i} style={{ display: 'flex', gap: 14, padding: '11px 0', borderBottom: '1px solid var(--line)' }}>
              ...
              <div>
                <div style={{ fontWeight: 600, fontSize: 15.5, letterSpacing: '-0.01em' }}>
                  {e.n}{e.star && <span style={{ color: 'var(--teal)', fontSize: 12 }}> ★</span>}
                </div>
