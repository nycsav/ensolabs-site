# LinkedIn Article — paste the body, insert 4 GIFs where marked

**Cover:** upload `A-COVER-1920x1080.png` → "Add a cover image"
**Title:** Build an Agent Harness: The 4 Inputs That Get AI Agents Into Production

Each `>>> INSERT` line = click the image button in the LinkedIn editor, upload that
file, delete the marker line. GIFs animate inside LinkedIn articles.
...
>>> INSERT B1-crossing-38-to-11.gif
...
>>> INSERT B2-four-inputs-spec.gif
...
>>> INSERT B3-benchmark-27-to-49.gif
...
>>> INSERT B4-bridge-harness.gif

A suspension bridge goes up in a fixed order. Deck, towers, main cable, suspenders — then the load. Reverse it and nothing stands.

Reverse it with an agent and you join the 89%.
...
Full version, with the complete source list:
