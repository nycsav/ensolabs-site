...
export const personSchema = (): JsonLd => ({
  ...
  knowsAbout: [
    ...
    'AI Advertising and Marketing Automation',
    'LangGraph',
    'Model Context Protocol',
    'Retrieval-Augmented Generation',
    'Multi-Agent Orchestration',
    'Cloud Managed Services for AI',
    'Financial Signal Intelligence',
    'Autonomous Trading Systems',
    'Responsible AI Governance',
    'Healthcare AI and Pharma Compliance',
...
export const localBusinessSchema = (): JsonLd => ({
  ...
  audience: {
    '@type': 'Audience',
    audienceType: ['Healthcare', 'Financial Services', 'B2B Technology', 'Advanced Manufacturing', 'Manufacturing', 'Industrial', 'Consumer', 'Advertising, Marketing & Media'],
  },
});
