...
export const INSIGHTS: Insight[] = [
  ...
  {
    slug: 'langchain-deep-agents-in-plain-english',
    title: 'LangChain Deep Agents in Plain English: What an "Agent Harness" Actually Is.',
    dek: 'At LangChain\'s San Francisco agent conference, the most impressive thing was not a benchmark — it was the language. LangChain takes the messy engineering behind a production AI agent and names it in words anyone can follow: harness, sandbox, memory, skills, human-in-the-loop. Here is the whole deep agents picture translated into plain English — and why making the complex simple is the actual product. Part 3 of our San Francisco field notes.',
    pillar: 'Build',
    date: '2026-05-31',
    readingMinutes: 7,
    tags: ['LangChain', 'Deep Agents', 'Agent Harness', 'LangGraph', 'LangSmith', 'AI Agents', 'MCP', 'A2A', 'Human-in-the-Loop', 'Agentic Systems', 'Context Engineering', 'Interrupt 2026'],
    faqs: [
      {
        question: 'What is a LangChain deep agent?',
        answer: 'A deep agent is LangChain\'s "batteries-included" agent harness — an open-source Python library (pip install deepagents) built on LangGraph that bundles the parts a production AI agent needs: a code interpreter and sandbox, a virtual filesystem, context management (memory, skills, summarization, prompt caching), human-in-the-loop approvals, and agent-to-agent connectivity. It turns a raw language model into a system that can actually carry out multi-step work.',
      },
      {
        question: 'What is an agent harness?',
        answer: 'An agent harness is everything built around a language model to make it useful: the loop that keeps it working, the tools it can call, its memory and file storage, context management, error handling, and human-approval checkpoints. The model is the engine; the harness is the rest of the car. LangChain\'s deep agents is one such harness.',
      },
      {
        question: 'How does human-in-the-loop work in LangChain deep agents?',
        answer: 'Deep agents can pause mid-run and wait for a person to approve, edit, or reject a sensitive action, for as long as needed. Because the pause is checkpointed, the agent can survive restarts and resume exactly where it stopped — which makes it safe to put real, consequential actions behind a human approval step.',
      },
    ],
    body: [
      'We spent May in San Francisco for the agent launch circuit — Google I/O, the Notion developer platform, and the [LangChain conference](https://interrupt.langchain.com/). We have already written up [Google\'s new agent stack](/insights/google-io-hackathon-managed-agents-omni-antigravity) and the [Notion career agent we shipped](/insights/notion-career-agent-open-source-hackathon). This one is about LangChain — and what struck us was not a new model or a benchmark. It was the language.',
      'LangChain has quietly become very good at something the rest of the industry is bad at: taking the genuinely complicated machinery behind a production AI agent and describing it in words a non-engineer can follow. Their [deep agents](https://www.langchain.com/deep-agents) session was a master class in it. So this piece does the same thing — it walks through the entire deep agents picture in plain English, one slide at a time.',
      '![A LangChain deep agents session in San Francisco — part of the May 2026 agent conference circuit](/images/insights/langchain-deepagents-01.jpg)',
      ...
      'A useful picture: the model is an engine. An engine bolted to nothing does not take you anywhere. The harness is the chassis, the fuel line, the steering, and the brakes. LangChain\'s [deepagents](https://github.com/langchain-ai/deepagents) is, in their words, a "batteries-included" harness — the whole car, assembled, instead of a box of parts.',
      ...
      '![Anatomy of a harness — the base deepagents stack: execution environment plus context management](/images/insights/langchain-deepagents-02.jpg)',
      ...
      '![First-class human-in-the-loop — draft action, interrupt, human review, then continue, all checkpointed](/images/insights/langchain-deepagents-04.jpg)',
      ...
      'Deploy the whole thing on [LangSmith](https://www.langchain.com/langsmith/deployment) and you inherit the production plumbing — versioning, instant rollbacks, fault tolerance — instead of building it yourself.',
      '![Agent interoperability — MCP for tools, A2A for other agents, RemoteGraph for remote deployments](/images/insights/langchain-deepagents-05.jpg)',
      ...
      'This is Part 3 of our San Francisco field notes — see [Part 1 on Google I/O](/insights/google-io-hackathon-managed-agents-omni-antigravity) and [Part 2 on the DeepMind after-hours](/insights/google-io-after-hours-deepmind-strategy-signal). If your team is trying to separate what is real from what is noise in the agent space — and turn it into something your leadership can actually act on — that is what Enso Labs is built to do. [Get in touch](/contact).',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'We ported the source-tier ranking system from [signal2noise](https://ensolabs.ai/insights), our market intelligence engine, into the career agent. Every job is classified by acquisition channel: Tier 1 (direct referral, ~50% interview rate) through Tier 5 (cold apply, ~2%). This changes the agent\'s behavior — a Tier 1 referral with a 60 match score still gets priority over a Tier 5 cold apply at 85.',
