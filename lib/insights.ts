...
export const INSIGHTS: Insight[] = [
  {
    ...
    title: "Every Ad Channel Has AI Now. Almost None of Them Talk to Each Other.",
    dek: "Marketers are running five AI tools across five channels. The brief still gets rewritten four times. Google and BCG surveyed 387 of them and found the gap — 81% want one integrated AI partner, 45% have one. Here's what that gap costs, and what closes it.",
    metaDescription: "81% of marketers want one AI partner across creative, media, commerce, and earned. 45% have one. Enso Labs explains why the gap is structural — and how managed AI agents for advertising close it.",
    pillar: 'Consult',
    lens: 'Brand',
    ...
    faqs: [
      {
        question: "Why don't AI tools work across advertising channels?",
        answer: "Most AI tools in advertising are built for a single channel — paid search, paid social, programmatic, email. Procurement buys them by channel, agencies staff for them by channel, and the brief that should span all of them gets rewritten at every handoff. The result: faster individual silos, but no reduction in the fragmentation between them. This is the structural gap Google and BCG identified in their January 2026 survey of 387 marketers.",
      },
      {
      ...
      {
        question: "What is the Publicis L'Oréal AI example and why does it matter?",
        answer: "Publicis used Gemini-powered AI to decode the intent behind consumers' complex beauty queries, delivering personalized skincare recommendations directly within search. The result was 2× conversions compared to the baseline, piloted in Chile and now scaling globally. It matters because the lift is attributable to a single workflow change — not a new channel, not a bigger budget. That's the proof standard for what integrated AI orchestration produces in advertising.",
      },
    ],
    body: [
      ...
      "Those four inputs are: **the brief, the journey map, the measurement plan, and the segmentation.** These are the things that live between channels — and that's exactly where they get lost. A channel specialist inherits them secondhand or rewrites them from scratch. A managed agent holds all four and reports back in the same currency: media dollars, channels, days, and leads.",
      "This is not a replacement for creative or media teams. It's the layer that carries their shared inputs so that each team is working from the same brief, not a branch of it.",
      "## The proof standard",
      "Publicis × L'Oréal. Gemini-powered AI decoding the intent behind consumers' complex beauty queries, serving personalized skincare recommendations inside search. **2× conversions versus baseline.** Piloted in Chile, now scaling globally.",
      "That result is attributable to one thing: a workflow change. Same channels, same team, same budget. Different orchestration layer. The benchmark is on the left, the client's measured number is on the right. That is the standard we hold [Enso Labs' managed AI agents for advertising](/services/ai-growth-marketing) to.",
      "## The question to ask at your next agency review",
      "Which of my four inputs do you hold — the brief, the journey map, the measurement plan, the segmentation — and which channels does it travel across? One channel: you have a specialist. All of them: you have an orchestrator. That's where 97% of your peers say the next dollar goes.",
