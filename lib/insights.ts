...
export const INSIGHTS: Insight[] = [
  {
    ...
    body: [
      ...
      "![The four-step deployment loop at the heart of every AI-native startup — retrieve and rank, build prompt, call Claude, parse and validate](/images/insights/fds-part4-deploy-loop.gif)",
      ...
      "![Anthropic's three-tier permission model — Anthropic sets absolute limits through training, the operator sets system prompt and tool access, the user makes runtime requests](/images/insights/fds-part4-permission-model.gif)",
