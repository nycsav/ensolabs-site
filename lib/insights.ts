...
export const INSIGHTS: Insight[] = [
  ...
  },
  {
    ...
    ogImage: '/og/og-frontier-labs-fde-platform-theory-v1.png',
    readingMinutes: 6,
    ...
    body: [
      "## TL;DR",
      "- [ ] **Three labs, three theories of production** — Anthropic governs, OpenAI operates full-stack, Perplexity grounds intelligence in real time. Treating them as interchangeable is an architecture mistake.",
      "- [ ] **The lab shapes what you build on top of it.** Anthropic gives FDS practitioners the governance plumbing. OpenAI gives reasoning and coding speed. Perplexity gives the intelligence feed. Route work accordingly.",
      ...
      "- [ ] **The four harness inputs do not change by lab.** The outputs — tools, permissions, retrieval strategy — are lab-specific architecture decisions.",
      ...
      "What Anthropic shipped that Forward Deployed Strategists actually build on: the [Model Context Protocol](https://ensolabs.ai/insights/claude-managed-agents-strategy-to-ship) (MCP), which turned from an open standard for tool integration into the de facto agent plumbing layer across the industry. And now, [enterprise managed authorization](https://www.anthropic.com/news/model-context-protocol), which went generally available on August 24.",
      ...
      "What makes that possible is the four harness inputs from [Part 2](https://ensolabs.ai/insights/agent-harness-inputs-outputs). The brief, the journey map, the measurement plan, the segmentation — those are the domain specificity. That is what the OpenAI FDE doesn't write before the build. The practitioner who writes them first has a layer of value OpenAI cannot commoditize by shipping a better model.",
