...
export type Insight = {
  ...
  title: string;
  dek: string;
  /** Optional ≤160-char SEO meta description. Falls back to `dek` when absent.
   *  The dek doubles as the visible standfirst and the OG/social description (both
   *  render long copy fine); Google truncates the search snippet near 155-160 chars,
   *  so a long dek costs snippet control on high-impression pages. */
  metaDescription?: string;
  /** Optional absolute <title> override (bypasses the "%s — Enso Labs" template). */
  metaTitle?: string;
  pillar: Pillar;
  date: string; // ISO
...
export const INSIGHTS: Insight[] = [
  {
    ...
    readingMinutes: 6,
    ogImage: '/og/og-agency-orchestration-gap-36-points-v1.png',
    heroImage: '/images/insights/agency-orchestration-gap-36-points/m1-hero.png',
    heroImageAlt: 'Two strategists mapping a customer journey on a whiteboard — The 36-point gap',
    tags: ['Strategy to Ship', 'Enso Labs', 'Sav Banerjee', 'Advertising', 'Managed AI agents', 'Agency orchestration', 'Google/BCG'],
    faqs: [
      { question: 'What is the 36-point gap?', answer: 'The difference between the 81% of marketers who want one integrated AI partner across creative, media, commerce and earned, and the 45% who have one (Google/BCG, N=387, Jan 2026).' },
      { question: 'Why does the gap persist if every agency has adopted AI?', answer: 'Because AI has been adopted silo by silo. Procurement buys by channel, ground teams stay channel specialists, and each silo picks its own tool. Workflows have not changed.' },
      { question: 'What does a managed agent carry across channels?', answer: 'Four shared inputs: the brief, the journey map, the measurement plan and the segmentation. It reports reallocation in media dollars, channels, days and leads.' },
      { question: 'Where is the AI budget coming from?', answer: 'Only 21% of marketers fund AI innovation with new budget; 45% reallocate from paid media and 35% from brand.' },
      { question: 'What is the proof standard for an integrated AI partner?', answer: 'A measured lift in a live account attributable to a workflow change, such as Publicis × L\'Oréal\'s 2× conversions from Gemini intent decoding in search.' },
    ],
    body: [
      '## The signal',
      '81% of marketers want one partner that orchestrates creative, media, commerce and earned. 45% have one.',
      'That 36-point gap is from Google and BCG\'s January 2026 survey of 387 marketers, published by Paul Limbrey in June. It is the largest open opportunity in advertising, and the diagnosis in the piece is the right one: the unit of transformation is the workflow.',
      '![36-point gap · 97% would increase spend · 74% raising AI-channel investment · 21% fund AI with new budget — Google/BCG, N=387, Jan 2026](/images/insights/agency-orchestration-gap-36-points/m2-stats.png)',
      '## Why it matters',
      '**Why the gap exists.** Procurement still issues RFPs by channel, so fragmentation is bought before any work starts. Agency ground teams stay channel specialists. And "AI transformation" has mostly meant each silo adopting its own tool. Faster silos, not fewer.',
      '![81% want an integrated partner vs 45% have one — a 36-point gap](/images/insights/agency-orchestration-gap-36-points/m3-gap.png)',
      '**Where the money is.** Only 21% of marketers fund AI innovation with new budget. 45% pull it from paid media, 35% from brand. The buyer is not adding spend — they are moving it. 97% say they would increase spend with a partner who can show where a reallocated dollar went and what it returned.',
      '![Where AI innovation budget comes from: 45% paid media, 35% brand, 21% new budget](/images/insights/agency-orchestration-gap-36-points/m3-budget.png)',
      '## The Enso take',
      '**What "integrated" means in production.** One system carries four inputs across every channel: the brief, the journey map, the measurement plan, the segmentation. Channel specialists never write these down because they live between channels. A managed agent does — that is the orchestration layer the survey is describing. It doesn\'t replace the creative or media teams; it carries their shared inputs and reports the reallocation in media dollars, channels, days and leads.',
      '![Four inputs a managed agent carries across channels: brief, journey map, measurement plan, segmentation](/images/insights/agency-orchestration-gap-36-points/m4-framework.png)',
      '**The proof standard.** Google\'s own example: Publicis for L\'Oréal, Gemini-powered intent decoding inside search, 2× conversions, piloted in Chile and scaling globally. A measured lift in a live account, attributable to a workflow change. That is the bar we hold Enso Labs\' Commercial Core — our managed-agent suite for advertising — to: benchmark on the left, the client\'s measured number on the right.',
      '![Publicis × L\'Oréal: 1× → 2× conversions with Gemini intent decoding in search (Think with Google, Jun 2026). Enso pair: MEASURING — Q4 2026](/images/insights/agency-orchestration-gap-36-points/m5-proof.png)',
      '## What to do about it',
      ...
      '1. **Who holds the brief** once it leaves the kickoff deck?',
      '2. **Where does the journey map live,** and which channel can see it?',
      '3. **What is the measurement plan,** and who enforces it mid-flight?',
      '4. **Which segmentation does media use** — and is it the same one creative uses?',
      'One channel per answer means you have specialists. The same answer four times means you have an orchestrator.',
      'Enso Labs builds managed AI agents for advertising and data analytics teams, from New York. If you want the four inputs carried across your channels, [talk to us](/contact) or see [what we ship](/services).',
      'Part 2 (Sep 15): the reallocation ledger — how we report a moved dollar in media dollars, channels, days and leads.',
      '**Powered by Enso Labs**',
    ],
  },
  {
    slug: 'ai-center-of-excellence-pharma-agency-compliance',
    title: 'AI that survives MLR review: how a pharma agency compressed campaign launches from three months to two weeks.',
    metaTitle: 'AI Center of Excellence for Pharma Advertising — Heller Agency | Enso Labs',
    dek: 'The bottleneck in pharma advertising AI is not content creation speed — it is knowledge. When the knowledge base comes first, MLR review cycles shrink. When it does not, faster AI just means more failed reviews. Here is the architecture that worked.',
    metaDescription: 'How Enso Labs built an AI Center of Excellence for a pharma agency — 83% faster campaign launches, FDA/MLR/PRC compliant, NIST AI RMF from day one.',
    pillar: 'Build',
    lens: 'Client',
    sourceCredit: 'Strategy to Ship',
    date: '2026-09-10',
    ...
    readingMinutes: 7,
    ogImage: '/og/og-ai-coe-pharma-v1.png',
    heroImage: '/images/insights/ai-coe-pharma/hero.jpg',
    heroImageAlt: 'Strategist reviewing regulatory documents at a desk — AI Center of Excellence for Pharma',
    tags: ['Pharma Advertising', 'MLR Compliance', 'AI Center of Excellence', 'NIST AI RMF', 'FDA', 'Managed AI Agents', 'Heller Agency', 'Enso Labs', 'Strategy to Ship'],
    faqs: [
      {
        question: 'What is an AI Center of Excellence for a pharma agency?',
        answer: 'A NIST AI RMF–governed program that integrates AI across brand teams while preserving FDA/MLR/PRC compliance. The Enso Labs model for Heller Agency: five brand knowledge bases, eight active automations, and a 83% reduction in campaign launch timelines — from three months to two weeks.',
      },
      {
        question: 'How do you maintain MLR compliance with AI-generated content?',
      ...
      {
        question: 'What is NIST AI RMF and how does it apply to pharma advertising AI?',
        answer: 'The NIST AI Risk Management Framework governs how AI systems are identified, measured, managed, and documented. For pharma advertising, it provides the audit trail that regulatory and legal teams require. Enso Labs designs every regulated engagement to NIST AI RMF from day one — governance architecture before prompt engineering.',
      },
      {
        question: 'What stack does Enso Labs use for pharma AI?',
        answer: 'MindStudio for the knowledge base and workflow layer, RAG (retrieval-augmented generation) for brand-grounded content, Claude for generation, and N8N for automation orchestration. The stack is designed to plug into existing MLR review workflows — not replace them.',
      },
    ],
    body: [
      ...
      '::stat 83% reduction in campaign launch time — from three months to two weeks',
      '::stat 8 active automations running across five brand teams',
      '::stat 100% MLR compliance maintained throughout the engagement',
      ...
      'If your agency is running pharma, biotech, or healthcare accounts and your AI initiatives keep failing MLR or stalling at the governance review, [talk to us](/contact). We scope regulated engagements in two weeks.',
      '**Powered by Enso Labs**',
    ],
  },
  {
    ...
    metaDescription: "How Motion, Anthropic, OpenAI, and Perplexity actually deploy AI in production — the models, the code patterns, the engineering decisions, and what a Forward Deployed Strategist needs to know at each layer.",
    pillar: 'Build',
    lens: 'Build',
    sourceCredit: 'Strategy to Ship',
    date: '2026-08-31',
    ...
    faqs: [
      {
        question: "What is the difference between RAG and real-time grounding in AI deployment?",
        answer: "RAG (Retrieval Augmented Generation) retrieves from a static knowledge base at query time. Real-time grounding, as Perplexity uses it, retrieves from live web sources at query time — the knowledge base is the entire current web, not a pre-indexed corpus. For forward deployment, RAG is appropriate when your data is proprietary and controlled; real-time grounding is appropriate when currency and breadth matter more than data control.",
      },
      {
        question: "What is MCP and why does it matter for enterprise AI deployment?",
    ...
    body: [
      ...
      "![The four-step deployment loop at the heart of every AI-native startup — retrieve and rank, build prompt, call Claude, parse and validate](/images/insights/fds-part4-deploy-loop.png)",
      ...
      "![Anthropic's three-tier permission model — Anthropic sets absolute limits through training, the operator sets system prompt and tool access, the user makes runtime requests](/images/insights/fds-part4-permission-model.png)",
  ...
  },
  {
    ...
    title: "The Labs Behind the Frontier: Anthropic, OpenAI, and Perplexity Are Not Interchangeable",
    dek: "Every Forward Deployed Strategist works with Anthropic, OpenAI, and Perplexity — but most practitioners treat them as interchangeable model vendors. They are not. Each lab has a distinct theory of production deployment. Here is why it is the architecture decision that determines whether your deployment survives.",
    metaDescription: "Anthropic, OpenAI, and Perplexity each have a distinct theory of forward deployment. The FDS who knows all three routes work correctly — and builds systems that last.",
    pillar: 'Build',
    lens: 'Build',
    sourceCredit: 'Strategy to Ship',
    date: '2026-08-27',
  ...
  {
    slug: 'agent-harness-inputs-outputs',
    title: "Build an Agent Harness: 4 Inputs That Get AI Agents Into Production",
    dek: "Only 11% of organizations have an AI agent running in production. The gap is not engineering — it is four inputs nobody wrote down before the build started. Here is the checklist, and what each input becomes inside the system.",
    metaDescription: "Only 11% of orgs have an AI agent in production. The agent harness checklist — 4 strategy inputs that decide whether yours ships.",
    pillar: 'Build',
    lens: 'Build',
    sourceCredit: 'Strategy to Ship',
    ...
    faqs: [
      {
        ...
        answer: "Everything in an agent that is not the model — prompt construction, tools, memory and state, permission boundaries, validators, and the evaluation loop. It is the software layer that turns a stateless model into a system that can run a task end to end. Practitioners group it into three tiers: Runtime, Capabilities, and Assurance.",
      },
      {
        question: "Why do most AI agent pilots fail to reach production?",
        answer: "Not because the model is weak. Deloitte's Tech Trends 2026 finds 38% of organizations piloting agents and only 11% running one in production. Leaders name evaluation gaps (64%), governance friction (57%), and model reliability (51%) as the blockers — all three are harness problems, and all three trace back to inputs nobody defined before the build started.",
      },
      {
        question: "How does a strategy deliverable become part of an agent?",
        answer: "Directly and one-to-one. The brief becomes the system prompt and the permission boundary. The journey map becomes the tool allowlist and the escalation gate. The measurement plan becomes the eval harness and its golden-set CI gates. The segmentation becomes the retrieval strategy and its recall target. Same craft, executable form.",
      },
      {
        question: "What does Enso Labs do before building an agent?",
        answer: "Enso Labs writes the inputs first — the outcome the agent serves, the actions it may take unattended, the point it must escalate to a human, and the metric that will prove it worked. Only then does the build start. Get in touch at https://ensolabs.ai/contact.",
      },
    ],
    body: [
      "## TL;DR",
      "::stat\n11% | of organizations have an agent in production\n4 | inputs decide whether yours is one of them\n49.6% | recall@1 after the harness changed — same model\n171% | average ROI on the agents that do cross",
      ...
      "Deloitte's Tech Trends 2026 puts 38% of organizations piloting and 11% in production. Gartner still expects [40%+ of agentic projects cancelled by 2027](https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027). Every named blocker is something a strategist decides, not something an engineer builds.",
      ...
      "![The input/output spec, animated — the brief becomes the system prompt and permission boundary, the journey map becomes the tool allowlist and escalation gate, the measurement plan becomes the eval harness and golden-set CI, and the segmentation becomes the retrieval strategy and recall target](/images/insights/geo-spec.gif)",
      ...
      "![Same model, different harness — Microsoft's AgenticRAG results, animated: BRIGHT recall@1 rising from a 27.8% embedding baseline to 49.6%](/images/insights/geo-benchmark.gif)",
      "Microsoft's [AgenticRAG](https://arxiv.org/abs/2605.05538) paper held the model constant and changed only how the system was allowed to look for evidence — a retrieval-strategy decision, made upstream, by whoever defined what \"relevant\" means for the business. It also hit 92% answer correctness on FinanceBench, within two points of being handed the right evidence outright.",
      ...
      "![The Golden Gate Bridge drawn as a line icon — deck, towers, main cable and suspenders assembling in sequence, the way a harness is built before the load arrives](/images/insights/geo-bridge.gif)",
      "## Do this next",
      "- [ ] **Write the escalation rule this week.** If nobody can say where the agent stops and a human takes over, it is not scoped — it is a demo with a roadmap.",
      "- [ ] **Name the one number that proves it worked** and put it in the eval harness on day one. If it cannot be measured on a golden set, it is not a metric, it is a hope.",
      "- [ ] **Audit your corpus before you shop for models.** Retrieval strategy moved the benchmark more than model choice did. The corpus is the variable you actually control.",
      "Stuck between a pilot and production? [Get in touch](https://ensolabs.ai/contact) — we write the inputs first, then build the system that satisfies them.",
    ...
    faqs: [
      {
        ...
        answer: "The business-facing half of forward deployment — the seat Palantir pioneered as the deployment strategist. They embed inside an organization, scope the problem, align the C-suite, define the outcome and the success metric, and own adoption end to end, then ship the system that delivers it. It sits at the intersection of strategy, consulting, and hands-on delivery.",
      },
      {
        question: "Is forward-deployed engineering only for people with an engineering background?",
        answer: "No. Palantir always paired an engineer with a deployment strategist, and the strategist role draws from management consulting, strategy, and — in Enso Labs' case — agency disciplines. Baseline technical fluency matters (agentic systems, RAG, evals, MCP, deployment strategy), but the scarce skill is reading the business and defining the outcome.",
      },
      {
        question: "How does an advertising or consulting background map to AI deployment?",
        answer: "Directly. Brand strategy is defining the outcome and the permitted claims (the system prompt and guardrails). Digital strategy is technical discovery. CX strategy is workflow and human-in-the-loop design. Data strategy is the eval harness, retrieval quality, and the success metric. Same craft, new stack.",
      },
      {
        question: "What AI skills should a forward-deployed strategist have?",
        answer: "Enough fluency to be credible: agentic system design, the agent harness (tools, evals, memory, observability, guardrails), RAG and retrieval quality, MCP and tool integration, human-in-the-loop escalation, and pilot-to-production deployment strategy — paired with the segmentation, brand-governance, and measurement craft that decides whether any of it lands with the business.",
      },
    ],
    body: [
      "![The Campanile at UC Berkeley at dusk with San Francisco beyond — key learnings on the agentic-AI trends of 2026, from Berkeley RDI's Agentic AI Summit](/images/insights/berkeley-campanile-hero.png)",
      "A few weeks ago I was in a sold-out hall at UC Berkeley for the [Agentic AI Summit 2026](/insights/berkeley-agentic-summit-demand-side-gap) — 5,000 people, four stages, and some of the sharpest builders in agentic AI in one place: Dawn Song, Peter DeSantis, Andrew Ng, Sergey Levine. Berkeley RDI had assembled the current frontier of the field, and between the sessions on secure and agentic AI, one question kept surfacing: who actually gets these systems into production?",
      ...
      "![The forward-deployed boom, animated — New York's share of U.S. forward-deployed roles counting up to about 35%, ahead of San Francisco's 11%, with the rest of the U.S. at 54% (Bloomberry / Paraform, 2026)](/images/insights/forward-deployed-strategist-dataviz-anim.gif)",
      "![The forward-deployed boom by the numbers — New York now holds about 35% of U.S. forward-deployed postings versus San Francisco's 11%, demand is up 10x in 18 months, comp runs $300K–$600K+, and top hirers include Palantir, OpenAI, Anthropic, Google, Databricks, and Scale AI](/images/insights/forward-deployed-strategist-dataviz.png)",
      ...
      "![The two seats of forward deployment — the Forward Deployed Engineer writes the code; the Deployment Strategist defines the outcome, drawn from brand, digital, CX, and data strategy](/images/insights/forward-deployed-strategist-part1.png)",
      ...
      "![One discovery method, two eras — the classic agency and consulting strategy method (stakeholder interviews, MECE framing, the brief, deployment, measurement) mapped phase by phase to forward-deployed AI](/images/insights/forward-deployed-strategist-method.png)",
      ...
      "![Sav Banerjee at the OpenAI Builder Lounge — in the room where frontier AI is built](/images/insights/forward-deployed-strategist-hero-photo.png)",
  ...
  },
  {
    ...
    body: [
      ...
      "## The signal",
      "This weekend, 5,000-plus people arrive at UC Berkeley for the [Agentic AI Summit 2026](https://rdi.berkeley.edu/events/agentic-ai-summit-2026), hosted by Berkeley RDI across four stages — Plenary, Atlas, Nexus and Compass. It is sold out. It is the strongest single concentration of agentic AI talent scheduled this year: Dawn Song on safe and secure agents, Peter DeSantis on infrastructure, Andrew Ng with Alfred Lin, Sergey Levine on robot foundation models, panels on capital markets, finance and legal, plus workshops from Replit, Databricks, Ema, Temporal and Circle.",
      ...
      "![The demand-side gap — Berkeley's agenda runs 100% supply-side while 39%/45%/84%/40%+ mark the demand side unready](/images/insights/berkeley-agentic-summit-demand-side-gap.png)",
      "That is not a criticism of the programme. It is an accurate picture of where the field's attention sits. The agenda is infrastructure, foundational capabilities, frameworks, evaluation, security, robotics, and vertical applications. It is a supply-side agenda, and the supply side is being solved with extraordinary force. Gartner forecasts worldwide AI spending of [$2.59 trillion in 2026, up 47%](https://www.gartner.com/en/newsroom/press-releases/2026-05-19-gartner-forecasts-worldwide-ai-spending-to-grow-47-percent-in-2026) (19 May 2026), with $585.5B of it in AI services. Global venture funding hit $510B in H1 2026, with more than 70% of second-quarter capital going to AI (Crunchbase, 2 Jul 2026).",
      "Now look at the other side of the transaction.",
      "::stat\n39% | of organisations have a shared customer data platform capable of supporting agentic AI (Adobe / Oxford Economics)\n45% | of martech leaders say vendor AI agents fail to meet promised business performance (Gartner)\n84% | of marketers admit they are still running generic campaigns (Salesforce)",
      "Only [39% of organisations have a shared customer data platform](https://business.adobe.com/blog/2026-adobe-ai-digital-trends-report-four-key-takeaways) capable of supporting agentic AI, and 52% say data quality and accessibility actively limit their AI (Adobe/Oxford Economics, n=3,000 executives, 19 Feb 2026). Gartner's [2026 CMO Spend Survey](https://www.gartner.com/en/newsroom/press-releases/2026-05-11-gartner-2026-cmo-spend-survey-finds-cmos-allocate-15-point-3-percent-of-marketing-budgets-to-ai-but-only-30-percent-are-ready-to-scale-ai-capabilities) found CMOs now allocate 15.3% of marketing budget to AI while only 30% consider themselves mature enough to scale it (n=401, 11 May 2026). [45% of martech leaders](https://www.gartner.com/en/newsroom/press-releases/2025-10-29-gartner-survey-finds-45-percent-of-martech-leaders-say-existing-vendor-offered-ai-agents-fail-to-meet-their-expectations-of-promised-business-performance) say the AI agents their existing vendors ship fail to meet promised business performance; 50% say their data and tech stack is not ready (Gartner, n=413, 29 Oct 2025). And [84% of marketers](https://www.salesforce.com/news/stories/state-of-marketing-2026/) admit they are still running generic campaigns (Salesforce, n=4,450, 19 Feb 2026).",
      "## Why it matters",
      "Put those two pictures side by side and the failure rate stops being mysterious.",
      "Gartner expects [more than 40% of agentic AI projects to be cancelled](https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027) by the end of 2027 — on escalating cost, unclear business value, and inadequate risk controls (25 Jun 2025). In a separate prediction, it expects [40% of enterprises to demote or decommission autonomous agents](https://www.gartner.com/en/newsroom/press-releases/2026-05-26-gartner-says-applying-uniform-governance-across-ai-agents-will-lead-to-enterprise-ai-agent-failure) by 2027 because governance gaps surfaced only after a production incident (26 May 2026).",
      ...
      "The commercial stakes just moved too. Gartner now puts [$234 billion of enterprise application software spend at risk](https://www.gartner.com/en/newsroom/press-releases/2026-07-01-gartner-says-us-dollars-234-billion-in-enterprise-application-software-spend-is-at-risk-from-agentic-artificial-intelligence) from agentic AI, with vendors forced to move from interface-based value to outcome-based value (1 Jul 2026). Outcome-based value is not a pricing tweak. It means the party who defines the outcome — the segment, the offer, the acceptable answer — captures the margin. That party has historically been the agency and the CMO, not the systems integrator.",
      "And the channel underneath all of it is moving. [68.01% of US Google searches now end without a click](https://sparktoro.com/blog/in-2026-less-than-one-third-of-google-searches-still-send-a-click/), up from 60.45% in 2024 (SparkToro/Similarweb, 9 Jun 2026), while AI Overviews appear on 43% of searches as of July 2026 versus 15% a year earlier (Similarweb, 27 Jul 2026). The first-party data and structured content that feed an agent are the same assets that decide what an answer engine says about you. One investment, two returns.",
      "## The Enso take",
      ...
      "## What to do about it",
      "- [ ] **Write the brief before the next agent.** One page per agent: the segment it serves, the value of that segment, the approved claims, the escalation rule, and the single number that defines success. If it cannot be written, the agent should not be built.\n- [ ] **Audit whether your data can feed an agent at all.** If you are in the 61% without an agent-ready customer data layer, that is the first quarter of work — not the orchestration framework.\n- [ ] **Price the outcome, not the seat.** Buyers are already benchmarking advisors against per-resolution pricing. Decide your number before procurement decides it for you.\n- [ ] **Treat first-party content as answer-engine infrastructure.** The same structured assets that ground your agents determine what AI search says about you. Fund it once, count it twice.",
      "If you are at Berkeley this weekend, we would like to argue about this in person. If you are not, we are running production-gap reviews for teams with agents live and results flat — the [pharma AI Center of Excellence](/work/heller) and [enterprise enablement](/work/enterprise-ai) case studies are the shape of the work.",
  ...
  },
  {
    ...
    faqs: [
      {
        question: "What is the 'code is free' thesis from AGI Summit 2026?",
        answer: "Jeremiah Owyang, General Partner at Blitzscaling Ventures, argues that code and AI models are now commodities — a technical lead gets copied in weeks — so durable AI companies are built on a flywheel of data, community, product-led growth, distribution, and network effects. He presented it at AGI Summit 2026 (July 18–19, Palace of Fine Arts, San Francisco), with Composio's 1,000+ app-connection integration graph as the worked example of a moat that isn't code.",
      },
      {
        question: "How concentrated was AI venture funding in H1 2026?",
        answer: "Global startup funding hit a record $510 billion in H1 2026 per Crunchbase — more than all of 2025 combined — but the money pooled rather than spread: more than 70% of Q2 capital went to AI companies (up from roughly 50% a year earlier), sixteen $1B+ rounds took 53% of Q2, and OpenAI and Anthropic alone absorbed $217 billion, 43% of the half.",
      },
      {
        question: "What makes an AI startup fundable in 2026?",
        answer: "Crunchbase CPO Ketaki Rao's screen from AGI Summit 2026: a market with long-term potential, clear positioning, a defensible moat (proprietary data feeding learning loops, embedded in workflows, with a distribution advantage), momentum investors can trust, and narrative. Crunchbase's own scorecard ranked narrative highest (82) and differentiation lowest (53) for the average AI startup — the story is currently outrunning the defenses.",
      },
      {
        question: "What makes an AI product defensible when models are commodities?",
        answer: "Everything the model isn't: proprietary data only you hold, a community only you convene, a seat inside the customer's workflow, distribution you own, and network effects that compound among them. Enso Labs encodes that domain advantage into managed agents and operates them in production — get in touch at https://ensolabs.ai/contact.",
      },
    ],
    body: [
      "![When code is free, the moat is everything the model isn't — field notes from AGI Summit 2026](/og/og-agi-summit-2026-code-is-free.png)",
      ...
      "That was the consensus hiding in plain sight at [AGI Summit 2026](https://agisummit.ai/) (July 18–19, Palace of Fine Arts, San Francisco) — the first of the two Bay Area summits [we announced we'd be attending](/insights/enso-labs-sf-agentic-ai-summits-2026). Two talks, given independently — one by the executive who ranks startups for a living, one by the investor who underwrites them — converged on the same map of what survives when intelligence gets cheap.",
      "## The signal",
      "Ketaki Rao, Crunchbase's Chief Product Officer, opened \"How to build a fundable AI startup\" with a paradox from her own data: there is more venture money than ever, and it is harder than ever to get. Global startup funding hit [a record $510 billion in H1 2026](https://news.crunchbase.com/venture/global-startup-exits-ipo-ma-soar-ai-q2-h1-2026/) — more than all of 2025 combined — but the money is pooling, not spreading. More than 70 percent of Q2 capital went to AI companies, up from roughly 50 percent a year earlier. Just sixteen billion-dollar-plus rounds took 53 percent of the quarter. And two companies — OpenAI and Anthropic — absorbed $217 billion, 43 percent of everything raised in the half.",
      "::stat\n$510B | record global venture funding in H1 2026 — more than all of 2025\n70%+ | of Q2 capital went to AI, up from ~50% a year earlier\n43% | of the half went to two companies — OpenAI and Anthropic",
      "![Where the record H1 2026 money went — $510B half, 70%+ of Q2 to AI, 53% to sixteen $1B+ rounds, 43% to two companies](/images/insights/agi-summit-2026-market-backdrop.png)",
      "For everyone not named OpenAI or Anthropic, Rao's answer is a five-part screen: a real market, sharp positioning, a defensible moat — proprietary data feeding learning loops, embedded in the customer's workflow, with distribution — momentum, and narrative. Then she showed the room what Crunchbase's scoring — the machinery behind its [Heat Score](https://support.crunchbase.com/hc/en-us/articles/39902159873043-What-is-a-Heat-Score) — sees in the average AI startup today: Narrative 82, Momentum 74, Market 68, Moat 65, Differentiation 53. Read that ranking again. The story is the strongest thing about the average AI startup. The defensibility and the differentiation are the weakest.",
      "::stat\n82 | Narrative — the top score on Crunchbase's AI-startup scorecard\n53 | Differentiation — the lowest, 29 points behind the story",
      "A day later, Jeremiah Owyang — General Partner at Blitzscaling Ventures — gave the investor's version in [\"How to Win When Code Is Free\"](https://www.linkedin.com/posts/jowyang_how-to-win-when-code-is-free-building-ai-activity-7482794598088499200-plbq). His premise: code is now a commodity — a clever technical lead gets copied in weeks — so he underwrites the flywheel instead: **Data → Community → Product-led growth → Distribution → Network effects**, each stage feeding the next. Data is the proprietary lever few can access; community converts users into product innovation and de-facto-standard loyalty; product-led growth is features that spread user to user; distribution is the partner channel that enters markets at low cost; network effects put you at the center of the ecosystem. His worked example was [Composio](https://composio.dev), whose 1,000-plus app connections and just-in-time tool calls make the integration graph — not the code — the asset a competitor would have to rebuild. His closing instruction to the room: spin your flywheel.",
      "![Owyang's flywheel — Data feeds Community feeds Product-led growth feeds Distribution feeds Network effects, and back around](/images/insights/agi-summit-2026-flywheel.png)",
      "## Why it matters",
      ...
      "![The convergence map — Crunchbase's fundability screen and Blitzscaling's flywheel are the same five rows](/images/insights/agi-summit-2026-convergence-map.png)",
      ...
      "The pattern across all three: a moat is not a slide. It is operated — fed, measured, and defended weekly. That is [the work we do](/services): encoding what a company uniquely knows into managed agents, then running them in production, where the flywheel actually turns.",
      "## What to do about it",
      "- [ ] **Score yourself on the five stages before your next raise.** Data, community, product-led growth, distribution, network effects — one honest sentence per stage. The blank ones are your roadmap, and investors are running this screen whether you do or not.",
      "- [ ] **Turn your dataset into a learning loop.** Proprietary data that doesn't make the product measurably better each week is a storage bill, not a moat. Instrument the loop before you pitch it.",
      "- [ ] **Embed where the work already happens.** A destination product competes with every open tab; a workflow seat — inside the approval path, the CRM, the terminal — has to be actively ripped out.",
      "- [ ] **Close the narrative-moat gap from the moat side.** If your story scores 82 and your defensibility 65, invest in the 65. The story is the cheapest thing in the room to copy.",
      "If you're building or buying AI and the moat conversation is overdue, [get in touch](/contact) — we're in SF through the [Berkeley Agentic AI Summit on August 1–2](/insights/enso-labs-sf-agentic-ai-summits-2026).",
      "**Powered by Enso Labs**",
    ],
  },
  {
    ...
    body: [
      ...
      "> **What this means for a founder or an investor:** agent products are shipping far faster than the go-to-market behind them. If your product — or your portfolio — is ahead of its story, the decision to revisit is whether distribution gets engineered and operated with the same discipline as the product, or waits on GTM hires that barely exist at scale.",
      ...
      "The gap is visible in the data: nearly half of [Y Combinator's recent batches are AI-agent companies](https://pitchbook.com/news/articles/y-combinator-is-going-all-in-on-ai-agents-making-up-nearly-50-of-latest-batch), postings for [forward-deployed engineers grew more than 700 percent year over year](https://bloomberry.com/blog/i-analyzed-1000-forward-deployed-engineer-jobs-what-i-learned/), and in [CB Insights' analysis of 431 venture-backed shutdowns](https://www.cbinsights.com/research/report/startup-failure-reasons-top/), 43 percent traced back to poor product-market fit. Everyone is building agents; almost no one is building the story and the customer-acquisition engine behind them. That's the layer we operate: fifteen years of New York brand and demand craft, encoded as managed agents — go-to-market for funded startups, agentic commercial layers for enterprises and SMBs.",
  ...
  },
  {
    ...
    metaDescription: "Enso Labs is a Perplexity Implementation Partner. What the Perplexity Computer partner program covers, and how to get your team onto it.",
    pillar: 'Build',
    lens: 'Build',
    date: '2026-07-05',
    dateModified: '2026-09-09',
  ...
  },
  {
    ...
    metaDescription: "Claude's agents now learn, grade themselves, and split the work. What outcomes, dreaming, and multiagent orchestration mean for enterprise AI teams.",
    pillar: 'Build',
    lens: 'Build',
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        question: 'What is a principal-led AI consulting studio?',
        answer: "A principal-led AI consulting studio is a firm where the same senior advisor who scopes the engagement also writes the code, runs the evals, and presents to the board. There are no account managers, no junior delivery teams, and no hand-offs between strategy and engineering. Enso Labs is a principal-led AI transformation studio based in NYC — Sav Banerjee scopes, builds, and operates every engagement.",
      },
      {
    ...
    body: [
      ...
      'The question for every enterprise evaluating AI consulting partners is not "which firm has the largest Claude partner tier?" It is: "who is actually building and operating our system, and do they have the continuity to own the outcome?" [Get in touch](/contact) and we will show you the systems we run, not just the slides we have pitched.',
      '**Powered by Enso Labs** — a principal-led AI transformation studio in New York City. [View our services](/services) or [our case studies](/work).',
    ],
  },
  {
