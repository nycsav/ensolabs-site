...
export const INSIGHTS: Insight[] = [
  {
    ...
    body: [
      ...
      "[Part 1](https://ensolabs.ai/insights/forward-deployed-strategist-agency-lineage) argued that the scarce half of forward deployment is the strategist seat: reading the business, defining what the system is for, owning whether it gets adopted. This is the follow-through. What does that seat actually hand over, and what comes back?",
      "## The crossing almost nobody makes",
      "Deloitte's [Tech Trends 2026](https://www.deloitte.com/us/en/insights/topics/technology-management/tech-trends.html) puts 38% of organizations piloting agents and 11% running one in production. Gartner still expects [more than 40% of agentic projects to be cancelled by the end of 2027](https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027). The interesting part is what leaders blame.",
      "![The crossing, animated — 38% of organizations piloting agents against 11% in production, with evaluation gaps at 64%, governance friction at 57%, model reliability at 51%, and 171% average ROI for the agents that do cross (Deloitte, PagerDuty, 2026)](/images/insights/agent-harness-gap-anim.gif)",
      "Evaluation gaps (64%), governance friction (57%), model reliability (51%). Not one of those is a model-capability problem. All three are harness problems, and all three trace back to an input nobody wrote down before the build began. Meanwhile the agents that do cross return an average [171% ROI](https://www.digitalapplied.com/blog/agentic-ai-statistics-2026-definitive-collection-150-data-points), with a median payback under nine months. The gap is not technical difficulty. It is unspecified work.",
      ...
      "## The output spec",
      "Here is the part that makes this concrete rather than tidy: the outputs are numbers, and they are now benchmarkable. Microsoft's [AgenticRAG](https://arxiv.org/abs/2605.05538) paper (May 2026) gave a model search, open, and summarize tools instead of one-shot retrieval, and measured what came out — 49.6% recall@1 on BRIGHT, 21.8 points over the best embedding baseline, and 92% answer correctness on FinanceBench, within two points of having oracle access to the true evidence.",
      ...
      "## What to do about it",
      "- [ ] Write the escalation rule before the architecture. If nobody can say where the agent stops and a human starts, the deployment is not scoped — it is a demo with a roadmap.",
      "- [ ] Name the single number that would prove this worked, and put it in the eval harness on day one. If it cannot be measured on a golden set, it is not a success metric, it is a hope.",
      "- [ ] Judge the data before the model. Retrieval strategy moved the AgenticRAG benchmark more than model choice did. Your corpus is the variable you actually control.",
