...
export const INSIGHTS: Insight[] = [
  {
    ...
    title: 'Building AI Agents on the Notion Developer Platform: A Career Intelligence Agent in 24 Hours',
    dek: 'Notion Workers, Notion MCP, and a two-model Claude pipeline — how we shipped a production-grade career agent at the first Notion Developer Platform Hackathon during SF AI Week 2026.',
    pillar: 'Build',
    date: '2026-05-19',
    readingMinutes: 8,
    body: [
      'Notion AI agents are production-ready. At the first [Notion Developer Platform Hackathon](https://www.notion.com/product/developer-platform) during SF AI Week 2026, we shipped a career intelligence agent — five Notion Worker tools, 487 lines of TypeScript, a full pipeline from job scanning to AI-tailored resume generation — in 24 hours. The project is live on [GitHub](https://github.com/nycsav/notion-career-agent) and represents one of the first publicly available agents built entirely on Notion Workers.',
      '![Building at Notion HQ during SF AI Week 2026](/images/insights/notion-hackathon-building.jpg)',
      '## What Is the Notion Developer Platform?',
      'The [Notion Developer Platform](https://www.notion.com/product/developer-platform), launched May 13, 2026, gives developers a cloud-native runtime for building AI-powered tools that run inside Notion workspaces. The platform includes three core primitives: **Notion Workers** (sandboxed TypeScript functions executed on Notion infrastructure), **Notion MCP** (Model Context Protocol servers that let AI assistants read and write Notion data), and an **Agent SDK** for external integrations. Workers are free during beta, with credit-based pricing starting August 11, 2026.',
      'For builders, this means you can ship AI agents that live where your users already work — inside Notion — without managing servers, auth flows, or deployment pipelines. The Notion CLI handles deployment. The Notion SDK handles database reads and writes. You write the logic.',
      '## The Problem: Job Search Does Not Scale',
      ...
      '![The Notion Hackathon team at Annie Street, San Francisco](/images/insights/notion-hackathon-team.jpg)',
      ...
      'The career agent is a compressed case study of what we do at Enso Labs across every client engagement. We take a workflow that runs on human effort and spreadsheets, decompose it into discrete automation stages, insert AI at the points where it creates the most leverage, and keep humans in the loop where judgment matters. The 24-hour constraint forced us to be ruthless about scope — and that is exactly how enterprise AI deployments should be scoped.',
      'Notion Workers and the broader Notion Developer Platform are opening a new distribution channel for AI agents. The workspace is the interface. The Worker is the runtime. Notion MCP is the data layer. For builders and enterprises evaluating where to ship their next AI agent, Notion just became a serious platform option.',
      'The full source code is available at [github.com/nycsav/notion-career-agent](https://github.com/nycsav/notion-career-agent). We build AI agents on Notion and other platforms — if you are evaluating Notion Workers for your team, [get in touch](/contact).',
    ],
  },
  {
